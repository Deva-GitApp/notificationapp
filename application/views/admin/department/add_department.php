        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box box-info">
                    ...
                    echo form_open_multipart('admin/department/create', $attributes);
                    ?>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" id="department_name" placeholder="Department Name" name="department_name" value="<?php echo set_value('department_name'); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="department_code" class="col-lg-2 control-label">Department Code</label>
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" id="department_code" placeholder="Department Code" name="department_code" value="<?php echo set_value('department_code'); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
