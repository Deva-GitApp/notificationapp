        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box box-info">
                    ...
                    echo form_open('admin/dbbkdetails/create', $attributes);
                    ?>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-body">
                                        ...
                                        <div class="col-lg-4 department">
                                            <select class="form-control select2" name="fk_project_id" id="fk_project_id">
                                                ...
                                                foreach ($project_list as $value) {
                                                    ?>
                                                    <option value="<?php echo $value['project_id']; ?>" <?php echo set_select('project_id', $value['project_id']); ?>><?php echo $value['project_name']; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" id="db_name" placeholder="DataBase Name" name="db_name" value="<?php echo set_value('db_name'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" id="db_path" placeholder="DataBase Path" name="db_path" value="<?php echo set_value('db_path'); ?>">
                                    </div>
                                </div>

                                <div class="form-group">                                    
                                    <div class="col-lg-offset-2 col-lg-4">
                                        <button type="submit" id="btn_submit" class="btn btn-primary hvr-bounce-out">Add</button>
