...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?php echo base_url('admin/payment/view_payment_details'); ?>">Delayed Payment Details</a></li>
        </ol>
...
//        "columnDefs": [{orderable: false, targets: [4, 7, 10, 8]}],
        ...
        "ajax": {
            "url": "<?php echo base_url('admin/payment/ajax_delayed_payment_details_datatable') ?>",
            "dataType": "json",
            "type": "POST",
