...
<body>
    ...
    <div id="makepdf" class="container">
        <div class="hallticketmaincontainer">
            <div class="container">
                <div class="pdfheader">
                    <div class="row justify-content-between">
                        <div class="col-6" style="position: relative;">
                            <div class="pdflogo">
                                <img src="<?= base_url('admin_assets') ?>/dist/img/new-sriher-logo.png" class="img-fluid" />
                            </div>
                        </div>
                        <!--div class="col-8">
                        <div class="logo-txt-container">
                            <h3 class="mainheadlogo">SRI RAMACHANDRA</h3>
                            <p class="sub-head">INSTITUTE OF HIGHER EDUCATION AND RESEARCH</p>
                            <p class="sub-head sml">(Deemed to be University)</p>
                            <p class="sub-head sml">Porur, Chennai - 600 116.</p>
                        </div>
                    </div-->
                        <div class="col-2">
                            <div class="profile-pic">
                                <?php
                                $res = IsRemoteFile('https://digicampus.sriramachandra.edu.in/uploads/student_picture/M0116250.jpg');
                                //echo $res;
                                ?>
                                <img src="https://digicampus.sriramachandra.edu.in/uploads/student_picture/" <?php echo $hallticket_details[0]['student_barcode'] . '.jpg' ?> class="img-fluid" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered tblcus">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width: 250px;">Course</th>
                                <th class="text-center">Date</th>
                                <th class="text-center" style="width: 150px;">Exam Time</th>
