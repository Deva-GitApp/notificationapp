...
class Styles extends BaseParserClass
{
    ...
    {
        if ($alignmentXml->alignment != null) {
            $alignment->setHorizontal((string) isset($alignmentXml->alignment['horizontal'])) ? $alignmentXml->alignment['horizontal'] : '';
            $alignment->setVertical((string) isset($alignmentXml->alignment['vertical']) ? $alignmentXml->alignment['vertical'] : '');

            $textRotation = 0;
            if ((int) isset($alignmentXml->alignment['textRotation']) ? $alignmentXml->alignment['textRotation'] : ''  <= 90) {
                $textRotation = (int) isset($alignmentXml->alignment['textRotation']) ? $alignmentXml->alignment['textRotation'] : '';
            } elseif ((int) isset($alignmentXml->alignment['textRotation']) ? $alignmentXml->alignment['textRotation'] : ''  > 90) {
                $textRotation = 90 - (int) isset($alignmentXml->alignment['textRotation']) ? $alignmentXml->alignment['textRotation'] : '';
            }

            $alignment->setTextRotation((int) $textRotation);
            $alignment->setWrapText(self::boolean((string) isset($alignmentXml->alignment['wrapText']) ? $alignmentXml->alignment['wrapText'] : ''));
            $alignment->setShrinkToFit(self::boolean((string) isset($alignmentXml->alignment['shrinkToFit']) ? $alignmentXml->alignment['shrinkToFit'] : ''));
            $alignment->setIndent((int) ((string) isset($alignmentXml->alignment['indent']) ? $alignmentXml->alignment['indent'] : '') > 0 ? (int) ((string) isset($alignmentXml->alignment['indent']) ? $alignmentXml->alignment['indent'] : '') : 0);
            $alignment->setReadOrder((int) ((string) isset($alignmentXml->alignment['readingOrder']) ? $alignmentXml->alignment['readingOrder'] : '') > 0 ? (int) ((string) isset($alignmentXml->alignment['readingOrder']) ? $alignmentXml->alignment['readingOrder'] : '') : 0);
        }
    }
