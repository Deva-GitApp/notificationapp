...
class Student_model extends CI_Model
{
    ...
    {
        $slt_ary = array(
            'ANY_VALUE(a.studenthallticket_id)',
            'ANY_VALUE(a.student_barcode)',
            'ANY_VALUE(a.dob)',
            'ANY_VALUE(a.halltcketcourse_name)',
            'ANY_VALUE(a.examdate)',
            'a.fk_student_id',
            'ANY_VALUE(a.examtime)',
            'ANY_VALUE(a.course_code)',
            'ANY_VALUE(a.yearsemhead)',
            'ANY_VALUE(a.status)',
            'ANY_VALUE(a.archive_status)',
            'ANY_VALUE(a.created_date)',
            'ANY_VALUE(b.student_name)',
            'ANY_VALUE(b.student_dob)',
            'ANY_VALUE(b.student_id)',
            'ANY_VALUE(b.hall_ticket_preview_status)',
            'ANY_VALUE(b.batch)',
