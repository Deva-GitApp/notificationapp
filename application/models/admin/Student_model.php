...
class Student_model extends CI_Model
{
    ...
    {
        $slt_ary = array(
            'ANY_VALUE(a.studenthallticket_id) as studenthallticket_id',
            'ANY_VALUE(a.student_barcode) as student_barcode',
            'ANY_VALUE(a.dob) as dob',
            'ANY_VALUE(a.halltcketcourse_name) as halltcketcourse_name',
            'ANY_VALUE(a.examdate) as examdate',
            'a.fk_student_id',
            'ANY_VALUE(a.examtime) as examtime',
            'ANY_VALUE(a.course_code) as course_code',
            'ANY_VALUE(a.yearsemhead) as yearsemhead',
            'ANY_VALUE(a.status) as status',
            'ANY_VALUE(a.archive_status) as archive_status',
            ...
            'ANY_VALUE(b.hall_ticket_preview_status) as hall_ticket_preview_status',
